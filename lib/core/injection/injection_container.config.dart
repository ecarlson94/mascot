...
import 'package:mascot/features/mascot/domain/usecases/get_mascot.dart' as _i31;
...
_i1.GetIt $init(
  ...
  gh.lazySingleton<_i17.MicrophoneService>(() => _i7.MicrophoneServiceImpl(
        gh<_i15.Microphone>(),
        gh<_i6.Logger<_i7.MicrophoneServiceImpl>>(),
      ));
  ...
  gh.factory<_i30.CreateMascotBloc>(
      () => _i30.CreateMascotBloc(gh<_i12.AddMascot>()));
  gh.factory<_i31.GetMascot>(
      () => _i31.GetMascot(gh<_i25.MascotsRepository>()));
  gh.factory<_i32.MascotAnimatorBloc>(
      () => _i32.MascotAnimatorBloc(gh<_i29.StreamMascot>()));
  return getIt;
}
