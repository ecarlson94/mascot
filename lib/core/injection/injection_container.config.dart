...
_i1.GetIt $init(
  ...
  gh.factory<_i5.Logger<_i6.WebMicrophone>>(() => _i6.MascotMicrophoneLogger());
  gh.factory<_i5.Logger<_i7.MascotsRepositoryImpl>>(
      () => _i7.MascotRepositoryLogger());
  gh.factory<_i5.Logger<_i8.SettingsRepositoryImpl>>(
      () => _i8.SettingsRepositoryLogger());
  gh.factory<_i5.Logger<_i9.ExpressionsRepositoryImpl>>(
      () => _i9.ExpressionsRepositoryLogger());
  gh.factory<_i5.Logger<_i10.MicrophoneServiceImpl>>(
      () => _i10.MicrophoneServiceImplLogger());
  ...
  gh.factory<_i15.MascotsRepository>(() => _i7.MascotsRepositoryImpl(
        gh<_i14.MascotsDriftDataSource>(),
        gh<_i13.MascotMapper>(),
        gh<_i5.Logger<_i7.MascotsRepositoryImpl>>(),
      ));
  gh.lazySingleton<_i16.Microphone>(() => _i6.WebMicrophone(
        gh<_i17.AudioContext>(),
        gh<_i5.Logger<_i6.WebMicrophone>>(),
      ));
  gh.lazySingleton<_i18.MicrophoneService>(() => _i10.MicrophoneServiceImpl(
        gh<_i16.Microphone>(),
        gh<_i5.Logger<_i10.MicrophoneServiceImpl>>(),
      ));
  ...
  gh.factory<_i21.SettingsRepository>(() => _i8.SettingsRepositoryImpl(
        ...
        gh<_i5.Logger<_i8.SettingsRepositoryImpl>>(),
      ));
  ...
  gh.factory<_i26.ExpressionsRepository>(() => _i9.ExpressionsRepositoryImpl(
        gh<_i25.ExpressionsDriftDataSource>(),
        gh<_i4.ExpressionMapper>(),
        gh<_i5.Logger<_i9.ExpressionsRepositoryImpl>>(),
      ));
