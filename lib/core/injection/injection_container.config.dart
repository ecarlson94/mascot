...
import '../../features/mascot/data/datasources/indexed_db/mascots_indexed_db_data_source.dart'
    as _i14;
import '../../features/mascot/data/models/mascot_mapper.dart' as _i13;
...
import '../../features/mascot/presentation/bloc/mascot_animator/mascot_animator_bloc.dart'
    as _i41;
import '../../features/microphone/device/microphone.dart' as _i15;
...
import '../../features/settings/data/datasources/indexded_db/settings_indexed_db_data_source.dart'
    as _i18;
import '../../features/settings/data/models/settings_mapper.dart' as _i19;
...
import '../device/web/js_interop/web_audio/web_audio.dart' as _i16;
...
_i1.GetIt $init(
  ...
  gh.lazySingleton<_i13.MascotMapper>(
      () => _i13.MascotMapperImpl(gh<_i5.ExpressionMapper>()));
  ...
  gh.factory<_i20.SettingsRepository>(() => _i21.SettingsRepositoryImpl(
        gh<_i18.SettingsIndexedDbDataSource>(),
        gh<_i19.SettingsMapper>(),
      ));
  gh.factory<_i22.StreamMicrophoneVolume>(
      () => _i22.StreamMicrophoneVolume(gh<_i17.MicrophoneService>()));
  gh.factory<_i23.StreamSettings>(
      () => _i23.StreamSettings(gh<_i20.SettingsRepository>()));
  ...
  gh.factory<_i28.ExpressionsRepository>(() => _i8.ExpressionsRepositoryImpl(
        gh<_i27.ExpressionsIndexedDbDataSource>(),
        gh<_i5.ExpressionMapper>(),
        gh<_i7.Logger<_i8.ExpressionsRepositoryImpl>>(),
      ));
  gh.factory<_i29.MascotsRepository>(() => _i12.MascotsRepositoryImpl(
  ...
  gh.factory<_i31.SaveTalkingThreshold>(
      () => _i31.SaveTalkingThreshold(gh<_i20.SettingsRepository>()));
  ...
  gh.factory<_i39.SaveMascotEffect>(
      () => _i39.SaveMascotEffect(gh<_i11.AddMascot>()));
