...
import '../../features/actions/presentation/bloc/actions_overlay_bloc.dart'
    as _i3;
import '../../features/camera/device/camera.dart' as _i27;
import '../../features/camera/device/web/web_camera.dart' as _i9;
...
import '../../features/mascot/domain/repositories/mascots_repository.dart'
    as _i31;
import '../../features/mascot/domain/usecases/add_mascot.dart' as _i12;
import '../../features/mascot/domain/usecases/get_mascot.dart' as _i39;
import '../../features/mascot/domain/usecases/stream_mascot.dart' as _i36;
...
import '../../features/settings/presentation/bloc/effects/stream_settings_effect.dart'
    as _i25;
import '../../features/settings/presentation/bloc/settings_bloc.dart' as _i35;
...
_i1.GetIt $init(
  ...
  gh.factory<_i7.Logger<_i9.WebCamera>>(() => _i9.MascotCameraLogger());
  ...
  gh.factory<_i7.Logger<_i12.AddMascot>>(() => _i12.AddMascotLogger());
  gh.factory<_i7.Logger<_i13.ExpressionsRepositoryImpl>>(
  ...
  gh.lazySingleton<_i18.MicrophoneService>(() => _i11.MicrophoneServiceImpl(
        gh<_i16.Microphone>(),
  ...
  gh.lazySingleton<_i27.Camera>(
      () => _i9.WebCamera(gh<_i7.Logger<_i9.WebCamera>>()));
  gh.factory<_i28.ExpressionTriggerFactory>(() => _i28.ExpressionTriggerFactory(
        gh<_i21.SettingsRepository>(),
        gh<_i23.StreamMicrophoneVolume>(),
      ));
  gh.lazySingleton<_i29.ExpressionsIndexedDbDataSource>(
      () => _i29.ExpressionsIndexedDbDataSource(
            gh<_i6.IndexedDbFactory>(),
            gh<_i6.IndexDbSettings>(),
          ));
  gh.factory<_i30.ExpressionsRepository>(() => _i13.ExpressionsRepositoryImpl(
        gh<_i29.ExpressionsIndexedDbDataSource>(),
        gh<_i5.ExpressionMapper>(),
        gh<_i7.Logger<_i13.ExpressionsRepositoryImpl>>(),
      ));
  gh.factory<_i31.MascotsRepository>(() => _i10.MascotsRepositoryImpl(
        gh<_i15.MascotsIndexedDbDataSource>(),
        gh<_i29.ExpressionsIndexedDbDataSource>(),
        gh<_i14.MascotMapper>(),
        gh<_i7.Logger<_i10.MascotsRepositoryImpl>>(),
      ));
  gh.factory<_i32.MicrophoneVolumeBloc>(
      () => _i32.MicrophoneVolumeBloc(gh<_i26.StreamVolumeEffect>()));
  gh.factory<_i33.SaveTalkingThreshold>(
      () => _i33.SaveTalkingThreshold(gh<_i21.SettingsRepository>()));
  gh.factory<_i34.SetTalkingThresholdEffect>(
      () => _i34.SetTalkingThresholdEffect(gh<_i33.SaveTalkingThreshold>()));
  gh.factory<_i35.SettingsBloc>(() => _i35.SettingsBloc(
        gh<_i25.StreamSettingsEffect>(),
        gh<_i34.SetTalkingThresholdEffect>(),
      ));
  gh.factory<_i36.StreamMascot>(
      () => _i36.StreamMascot(gh<_i31.MascotsRepository>()));
  gh.factory<_i37.StreamMascotEffect>(
      () => _i37.StreamMascotEffect(gh<_i36.StreamMascot>()));
  gh.factory<_i12.AddMascot>(() => _i12.AddMascot(
        gh<_i31.MascotsRepository>(),
        gh<_i30.ExpressionsRepository>(),
        gh<_i21.SettingsRepository>(),
        gh<_i7.Logger<_i12.AddMascot>>(),
      ));
  gh.factory<_i38.ExpressionAnimationService>(() =>
      _i38.ExpressionAnimationServiceImpl(gh<_i28.ExpressionTriggerFactory>()));
  gh.factory<_i39.GetMascot>(
      () => _i39.GetMascot(gh<_i31.MascotsRepository>()));
  ...
  gh.factory<_i41.SaveMascotEffect>(
      () => _i41.SaveMascotEffect(gh<_i12.AddMascot>()));
