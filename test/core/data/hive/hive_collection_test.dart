...
class TestHiveCollection extends HiveCollectionAdapter<HiveTestModel> {
...
void main() {
  ...
  late HiveTestModel model;

  setUp(() async {
    context = TestContext();
    collection = TestHiveCollection(context.mocks.hiveTestCollection);
    model = const HiveTestModel(id: 1, name: 'test');
  ...
  group('HiveCollection', () {
    ...
    group('add', () {
      ...
      test('should auto increment id when id is 0', () async {
        ...
        when(context.mocks.hiveTestCollection.put(any, any))
            .thenAnswer((_) async {});
        when(context.mocks.hiveTestCollection.length).thenReturn(3);
        var newModel = const HiveTestModel(id: 0, name: 'test');
      ...
      test('should not auto increment id when id is not 0', () async {
        ...
        when(context.mocks.hiveTestCollection.put(any, any))
            .thenAnswer((_) async {});
        when(context.mocks.hiveTestCollection.length).thenReturn(3);
        var newModel = const HiveTestModel(id: 1, name: 'test');
    ...
    group('getMany', () {
      late List<HiveTestModel> testModels;
      setUp(() {
        testModels = [
          const HiveTestModel(id: 1, name: 'test1'),
          const HiveTestModel(id: 2, name: 'test2'),
          const HiveTestModel(id: 3, name: 'test3'),
        ];
      });
