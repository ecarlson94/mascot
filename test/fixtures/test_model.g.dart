...
extension TestModelQueryFilter
  ...
  QueryBuilder<TestModel, TestModel, QAfterFilterCondition> hashCodeEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TestModel, TestModel, QAfterFilterCondition> hashCodeGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TestModel, TestModel, QAfterFilterCondition> hashCodeLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TestModel, TestModel, QAfterFilterCondition> hashCodeBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TestModelQuerySortBy on QueryBuilder<TestModel, TestModel, QSortBy> {
  QueryBuilder<TestModel, TestModel, QAfterSortBy> sortByHashCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hashCode', Sort.asc);
    });
  }

  QueryBuilder<TestModel, TestModel, QAfterSortBy> sortByHashCodeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TestModelQuerySortThenBy
  ...
  QueryBuilder<TestModel, TestModel, QAfterSortBy> thenByHashCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hashCode', Sort.asc);
    });
  }

  QueryBuilder<TestModel, TestModel, QAfterSortBy> thenByHashCodeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hashCode', Sort.desc);
    });
  }
...
extension TestModelQueryWhereDistinct
  ...
  QueryBuilder<TestModel, TestModel, QDistinct> distinctByHashCode() {
    return QueryBuilder.apply(this, (query) {
...
extension TestModelQueryProperty
  ...
  QueryBuilder<TestModel, int, QQueryOperations> hashCodeProperty() {
    return QueryBuilder.apply(this, (query) {
